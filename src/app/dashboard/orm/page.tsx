      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {stats.map((stat, i) => (
          <button
            ...
            className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-lg p-6 border border-white/20 flex flex-col items-center justify-center hover:scale-105 transition"
          >
            <h2 className="text-lg font-semibold text-indigo-100 mb-2">
              {stat.title}
            </h2>
